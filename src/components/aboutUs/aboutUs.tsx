...
import group7316 from '../../assets/Group 7316.png';
    ...
    return(
        ...
        <div className="rowTopAbout" id='section4'>
            ...
            <div className="colRT">
                ...
                <p>At <span className='emprix-marketing'>Emprix Marketing</span>, we're really good at boosting online stores using special plans for Facebook. Our skilled team mixes interesting stories with facts to make sure your brand connects with the right people. We've helped many big online stores grow on Facebook. We don't just show ads; we create stories. Start a personalized marketing journey with us, made just for your brand. Come with us and make your online mark even better.</p>
            </div>
        </div>

        </div>
        <div className="team-of-professionals-main-div">
        <div className="team-of-professionals-align-div">
            <div className="header-para-div">
                <h2>We have a team of professionals</h2>
                <p>We create custom plans for big online shops on social media. Our team of experts helps improve your brand's online experience. Let us enhance your business with special strategies made just for you.</p>
            </div>
            <div className="points-div">
                <div className="point-1 point">
                    ...
                    <div className="point-header-para">
                        ...
                        <p>Using what we know to help your brand stay ahead on Facebook.</p>
                    </div>
                </div>
                <div className="point-2 point">
                    ...
                    <div className="point-header-para">
                        ...
                        <p>Combining eye-catching pictures with interesting stories about the brand.</p>
                    </div>
                </div>
